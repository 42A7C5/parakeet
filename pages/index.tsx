    ...
    <>
      <div className={styles.gameList}>
        <Carousel className={styles.carousel} showArrows={false} showThumbs={false} showStatus={false} autoPlay={true}>
          <div className={styles.gameotw} style={{ background: 'url(https://dragondungeon.io/assets/img/game/bt-bg.png) center center no-repeat', boxShadow: '0 0 10px red', border: '0px solid red' }}>
            <div>
              <img src="https://dragondungeon.io/assets/img/skins/basic.png" style={{ height: '120px', width: 'auto' }} />
